...
class CampurFilter extends StatefulWidget {
  const CampurFilter({super.key});

  @override
  State<CampurFilter> createState() => _CampurFilterState();
}

class _CampurFilterState extends State<CampurFilter> {
  var loading = false;
  final list = <KosModel>[];
  String? id = "";
  ...
  Future<void> lihatKos() async {
    ...
    final response = await http.get(Uri.parse(
        'https://bengkaliskost.com/api/jkelamin.php?j_kelamin=campur'));
