...
class PutriFilter extends StatefulWidget {
  const PutriFilter({super.key});

  @override
  State<PutriFilter> createState() => _PutriFilterState();
}

class _PutriFilterState extends State<PutriFilter> {
  var loading = false;
  final list = <KosModel>[];
  String? id = "";
  ...
  Future<void> lihatKos() async {
    ...
    final response =
        await http.get(Uri.parse('https://bengkaliskost.com/api/jkelamin.php?j_kelamin=putri'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Categori Putri'),
