...
class DetailCategoryKos extends StatefulWidget {
  const DetailCategoryKos({super.key});

  @override
  State<DetailCategoryKos> createState() => _DetailCategoryKosState();
}

class _DetailCategoryKosState extends State<DetailCategoryKos> {
